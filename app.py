...
def save():
    ...
    with open("C:\Users\hp\Downloads\PRO-C136-Project-Boilerplate-main\PRO-C136-Project-Boilerplate-main\static\assets\datafiles\updated_product_dataset.csv") as f:
        f.write(data_entry)
